      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <h2 className="text-4xl md:text-5xl text-secondary-foreground leading-tight animation-fade-in animation-delay-100">
              Building the future,
            ...
            <div className="space-y-4 text-muted-foreground animation-fade-in animation-delay-200">
              <p>
                I'm a passionate software engineer with over 3.9+ years of
